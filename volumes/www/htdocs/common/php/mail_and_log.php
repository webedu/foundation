...
function printMailForm()
{
  ...
  if ($_POST) {
    echo "<p><b>Fehler beim Senden, bitte eMail-Adresse überprüfen!</b></p>";
  }
  ...
  //echo  "";
  echo " <div style='display:none;'><input type='hidden' name='ip' value='".$ip."'></div>";
  echo " <div style='display:none;'><input type='hidden' name='mt' value='".$mt."'></div>";  
